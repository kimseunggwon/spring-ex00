...
<div class="container">	
   ...
   $(function(){
	   $("#btn1").click(function() {
		   ...
		   $.post({
			   ...
			   contentType : "application/json",   //json타입명시 이유는?
   ...
   <button id="btn1">TEST CREAT - success</button>
  ...
  <script>
	...
	<h5>댓글 수정 form</h5>
	<input id="input1" name="rno" value="19" readonly> <br>
	<input id="input2" name="bno" value="50" readonly> <br>
